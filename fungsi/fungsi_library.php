...
function query_tahun() {
    ...
    $query_ajaran = mysqli_query("SELECT * FROM tahun_ajaran ORDER BY id_tahun_ajaran DESC LIMIT 1");
    ...
    $query_ajaran = mysqli_query("SELECT * FROM semester ORDER BY id_semester DESC LIMIT 1");
    $hasil_ajaran = mysqli_fetch_array($query_ajaran);
...
?>
    ...
    <?php
    $tampil = mysqli_query("SELECT * FROM kelas ORDER BY nama_kelas");
    if ($r['id_kelas'] == 0) {
...
?>
    ...
    <?php
    $query_dropdown_mengajar = mysqli_query("SELECT * FROM mengajar m
...
?>
    ...
    <?php
    $tampil = mysqli_query("SELECT * FROM materi m
                                                    ...
                                                    ORDER BY judul_materi") or die(mysqli_error());
...
function guru_by_nip() {
    $query = mysqli_query("select * from guru where nip=$_SESSION[id_pengguna]");
